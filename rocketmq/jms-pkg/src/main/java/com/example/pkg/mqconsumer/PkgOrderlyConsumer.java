package com.example.pkg.mqconsumer;
...
import com.example.pkg.utils.FastJsonUtil;
...
public class PkgOrderlyConsumer {
    ...
    public static final String NAMESERVER = "10.25.8.121:9876";
    ...
    private PkgOrderlyConsumer() throws MQClientException {
        ...
        this.consumer.setConsumeThreadMin(20);
        ...
        public ConsumeOrderlyStatus consumeMessage(List<MessageExt> msgs,
            ...
            for (MessageExt msg : msgs) {
                try {
                    ...
                    System.err.println(
                            "收到消息：" + "  topic :" + topic + "  ,tags : " + tags
                                    + "keys :" + keys + ", msg : " + msgBody);

                    Map<String, Object> body = FastJsonUtil
                            .convertJSONToObject(msgBody, Map.class);
